...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2025 at 05:58 AM
...
CREATE TABLE `anggota` (
  ...
  `kk` int(30) DEFAULT NULL,
  `email` varchar(25) NOT NULL,
  `nomor_hp` varchar(20) NOT NULL,
  `username` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL,
  `alamat` varchar(255) NOT NULL,
  `status` enum('siswa','umum') NOT NULL,
...
INSERT INTO `anggota` (`id_anggota`, `nama`, `kk`, `email`, `nomor_hp`, `username`, `password`, `alamat`, `status`, `nis`) VALUES
(3, 'Ahmad Subari m', 1223, 'admin@gmail.com', '123', '2234', '123', 'sini', 'siswa', ''),
(5, 'Ahmad ', 123, 'admin@gmail.com', '123', '2234', '123', 'peka', 'siswa', ''),
(6, 'beta', 1223, 'admin@gmail.com', '123', '2213', '123', 'akl', 'siswa', ''),
(7, 'demo', 1223, 'admin@gmail.com', '123', '34213', '2234', 'supra', 'siswa', ''),
(8, 'sahrul', 1223, 'admin@gmail.com', '123', '', '', 'm', 'siswa', ''),
(9, 'dicky afriansyah', 2147483647, 'vandicky@gmail.com', '08975956904', '', '', 'bugangan', 'siswa', ''),
(12, 'abu lahab', 2147483647, 'vandicky124@gmail.com', '08975956904', '', '', 'Desa Bugangan, Kecamatan Kedungwuni, Kabupaten Pekalongan, RT 001 RW 001, Nomer rumah 29', 'siswa', ''),
(13, 'Sahrul', 0, 'vandicky124@gmail.com', '08975956904', '', '', 'Desa Bugangan, Kecamatan Kedungwuni, Kabupaten Pekalongan, RT 001 RW 001, Nomer rumah 29', 'siswa', ''),
(14, 'Sahrul', 2147483647, 'vandicky124@gmail.com', '08975956904', '', '', 'Desa Bugangan, Kecamatan Kedungwuni, Kabupaten Pekalongan, RT 001 RW 001, Nomer rumah 29', 'siswa', ''),
(20, 'Sahrul', 2147483647, 'vandicky124@gmail.com', '08975956904', '', '', 'Desa Bugangan, Kecamatan Kedungwuni, Kabupaten Pekalongan, RT 001 RW 001, Nomer rumah 29', 'umum', ''),
(21, 'Ahmad Subari', 1223, 'admin@gmail.com', '0987654321', '', '', 'mm', 'umum', '9871320885270'),
(22, 'sahrul', NULL, 'admin@gmail.com', '0987654321', '', '', 'nko', 'siswa', '9871320885270'),
(23, 'Keripik Basreng', NULL, 'admin@gmail.com', '1234', '', '', 'll', 'siswa', '9871320885270'),
(24, 'sahrul', 98, 'admin@gmail.com', '0987697565', '', '', 'lk', 'umum', NULL),
(25, 'Ahmad Subari', 1223, 'admin@gmail.com', '123', '', '', 'bbbl', 'umum', NULL),
(26, 'Ahmad Subari', NULL, 'admin@gmail.com', '0987697565', '', '', 'lo', 'siswa', '9871320885270');
